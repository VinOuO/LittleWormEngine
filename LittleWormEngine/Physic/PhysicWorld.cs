...
namespace LittleWormEngine
{
    class PhysicWorld
    {
        ...
        {
            Init_Physic_World();
            Creat_Box(GameObject.Find("Box"));
            Creat_Box(GameObject.Find("Ashe"));
            Simulation();
            Clean_World();
        }
        ...
        static void Creat_Box(GameObject _Obj) //Use this to design collider component
        {
        ...
        static void Simulation()
        {
            ...
            for (int i = 0; i > -1; i++)
            {
                ...
                for (int j = dynamicsWorld.NumCollisionObjects - 1; j >= 0; j--)
                {
                    ...
                    if (j == 1)
                    {
                        GameObject.Find("Box").transform.Position = new Vector3(trans.Origin.X, trans.Origin.Y, trans.Origin.Z)/100;
                    ...
                    if (j == 2)
                    {
                        GameObject.Find("Ashe").transform.Position = new Vector3(trans.Origin.X, trans.Origin.Y, trans.Origin.Z)/100;
                        //Console.WriteLine(j + "pos : (" + trans.Origin.X + ", " + trans.Origin.Y + ", " + trans.Origin.Z + ")");
                        //body.LinearVelocity = new BulletSharp.Math.Vector3(_x, 0, 0);
                    }
                }
